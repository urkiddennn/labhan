    ...
    return (
        <section className="py-24 px-4 md:px-12 bg-white relative overflow-hidden">
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="w-full h-[600px] rounded-[4rem] border-8 border-slate-50 overflow-hidden relative group transition-all duration-700">
                    {shops === undefined ? (
                        <div className="absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">Syncing active shops</p>
                            </div>
                        </div>
                    ) : (
                        <MapContainer
                                ...
                                <Marker key={shop._id} position={[shop.latitude, shop.longitude]}>
                                    <Popup>
                                        <div className="p-3 text-center bg-white rounded-2xl">
                                            <h3 className="font-black italic uppercase tracking-tighter text-slate-800 text-lg mb-1 leading-none">{shop.name}</h3>
                                            <p className="text-[#69b8c4] font-black text-[10px] uppercase tracking-widest italic mb-3">Live Now</p>
