          ...
          <div className="bg-white rounded-3xl  border border-gray-200 overflow-hidden transform transition-all hover:scale-[1.01]">
            <div className="p-8 md:p-10">
              ...
              <div className="text-center mb-10">
                <h1 className="text-3xl font-bold text-[#69b8c4] mb-2">
                  Welcome Back
                </h1>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Mail
                      className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#69b8c4] transition-colors"
                      size={20}
                    />
                    <input
                      type="email"
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center ml-1">
                    ...
                    <a
                      href="#"
                      className="text-xs font-semibold text-[#69b8c4] hover:underline"
                    >
                      Forgot?
                    </a>
                  </div>
                ...
                <div className="flex items-center gap-2 ml-1">
                  <input
                    type="checkbox"
                    id="remember"
                    className="w-4 h-4 rounded border-gray-300 text-[#69b8c4] focus:ring-[#69b8c4]"
                  />
                  <label
                    htmlFor="remember"
              ...
              <p className="mt-8 text-center text-sm text-gray-600">
                ...
                <a
                  ...
                  className="ml-1 font-bold text-[#f7a83a] hover:underline"
                >
                  Create account
                </a>
              </p>
