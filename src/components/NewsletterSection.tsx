        ...
        <section className="py-24 px-4 md:px-12 bg-[#69b8c4]">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-5/12 relative">
                    ...
                    <div className="w-64 h-64 md:w-80 md:h-80 bg-white rounded-full overflow-hidden border-8 border-[#59a8b4] mx-auto">
                        <img
                ...
                <div className="md:w-7/12 text-white">
                    ...
                    <div className="flex flex-col sm:flex-row bg-white rounded-2xl sm:rounded-full p-1 max-w-md mx-auto md:mx-0 border border-blue-400">
                        <input
                            type="email"
                            placeholder="Ilagay ang iyong Email"
                            className="flex-grow px-6 py-3 rounded-2xl sm:rounded-l-full outline-none text-gray-700"
                        />
                        <button className="bg-[#f7a83a] text-white px-6 py-3 rounded-2xl sm:rounded-full font-bold hover:bg-orange-500 transition-colors mt-2 sm:mt-0">
                            Mag-Subscribe
                        </button>
                    </div>
                </div>
